...
/**
 * @author ThirumalM
 * Service for managing WebAuthn passkeys (credentials) for the currently authenticated user.
...
public class PasskeyManagementService {
     ...
     * @return true if the credential was deleted, false if not found or not owned by the user.
     */
