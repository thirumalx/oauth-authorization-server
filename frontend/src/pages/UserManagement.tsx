            ...
            <main className="page-main pt-12">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 text-[10px] font-extrabold text-indigo-600 uppercase tracking-[0.3em]">
                            <Users className="w-4 h-4" />
                            <span>identity provider</span>
                        </div>
                        <h1 className="text-4xl font-black text-slate-900 tracking-tight">Identity Management</h1>
                        <p className="text-slate-500 font-medium">Manage and monitor user identities across your organization.</p>
                    </div>
